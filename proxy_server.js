...
// 𝚂𝙴𝚁𝚅𝙴 𝙵𝚁𝙾𝙼 𝙵𝙸𝙻𝙴 — 𝙽𝙾𝚃 𝙵𝚁𝙾𝙼 𝙰 𝚅𝙰𝚁𝙸𝙰𝙱𝙻𝙴
dashApp.get('/', (req, res) => {
    res.sendFile(path.join(__dirname, 'public', 'index.html'));
});

// 𝙰𝙿𝙸 𝙴𝙽𝙳𝙿𝙾𝙸𝙽𝚃𝚂 (𝙽𝙾 𝙳𝚄𝙿𝙻𝙸𝙲𝙰𝚃𝙴𝚂)
dashApp.get('/api/logs', ...);
dashApp.get('/api/log/:filename', ...);
dashApp.get('/api/export/all', ...);
dashApp.get('/api/status', ...);
